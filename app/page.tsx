...
import {
  ...
  History,
  UserCircle,
  Code, // Keep Code icon for code generation features
  Sparkles,
  Zap,
  Upload,
  Download,
  ImageIcon,
  Wand2, // For 'Architect the impossible' tagline
  Loader2,
  AlertCircle,
  Info, // For About/Policy
  BookText, // For Privacy
  MessageSquare, // For main chat/home icon
} from "lucide-react"
...
• ♥️ **Multi-modal interactions** — seamlessly combine text, images, and other file types for advanced AI processing.`,
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-hidden relative max-w-full">
        <div className="container mx-auto px-4 py-6 max-w-5xl h-full flex flex-col relative z-10">
          <Card className="flex-1 card-bg flex flex-col shadow-2xl rounded-xl overflow-hidden">
            ...
            {/* Input Form */}
            <div className="flex-shrink-0 p-4 border-t card-bg">
              {/* Image Preview */}
              {selectedImage && (
                <div className="mb-3 relative inline-block">
                  <img
                    ...
                    className="max-w-28 max-h-28 rounded-lg shadow-lg object-cover"
                  />
                  <Button
              ...
              <form onSubmit={handleSubmit} className="flex gap-2 sm:gap-3 items-center">
                ...
                <Button
                  ...
                  className="text-secondary hover:text-primary focus-ring glass-button flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10"
                ...
                <Input
                  ...
                  className="flex-1 input-bg text-primary text-base py-2.5 px-4 focus-ring glass-input resize-none overflow-hidden h-10 sm:h-12"
                  disabled={isLoading}
                ...
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="text-primary hover:text-purple-400 focus-ring glass-button flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10"
      ...
      {/* Fixed at the bottom, responsive layout */}
      <footer className="flex-shrink-0 z-50 backdrop-blur-md bg-white/10 border-t border-white/20 p-2 sm:p-3">
        <div className="container mx-auto flex justify-around items-center max-w-xl">
          <Link href="/" aria-label="Home / Chat">
            <Button variant="ghost" size="icon" className="text-secondary hover:text-primary focus-ring glass-button flex-col gap-0.5 text-xs sm:text-sm">
